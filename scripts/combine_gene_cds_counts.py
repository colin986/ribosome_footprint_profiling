...
samples = { K : pd.read_table("results/diff_trans_analysis/quantitation/gene_cds_counts/%s.txt" % K,sep="\t",header=0,comment="#",index_col=None) for K in sample_names }
...
# save
combined_df.to_csv("results/diff_trans_analysis/quantitation/gene_cds_counts.txt",sep="\t",header=True,index=False,
